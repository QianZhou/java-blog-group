...
import qian.zhou.jbg.repository.RoleRepository;
...
public class InitDbService {
	...
	public void init() {
		if (roleRepository.findByName("ROLE_ADMIN") == null) {
			...
			/*
			 * Item item1 = new Item(); item1.setBlog(blogJavavids);
			 * item1.setTitle("first"); item1.setPublishedDate(new Date());
			 * item1.setLink("http://www.javaids.com");
			 * itemRepository.save(item1); Item item2 = new Item();
			 * item2.setBlog(blogJavavids); item2.setTitle("second");
